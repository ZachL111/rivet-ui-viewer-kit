"""Regression checks for the rivet-ui-viewer-kit casebook."""
...
from casebook.harness import assert_expected, rivet_ui_viewer_kit_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(rivet_ui_viewer_kit_summary(), assert_expected())
