...
rivet-ui-viewer-kit is a Lua project for frontend apps. It focuses on this technical goal: Develop a Lua command-oriented project for viewer scenarios with bounded scenario files, conflict explanations, and explicit failure cases.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 169, risk penalty 4, latency penalty 3, and weight bonus 3. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
